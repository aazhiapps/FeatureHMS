...
export const FloatingMoleculeAnimation: React.FC<
  FloatingMoleculeAnimationProps
> = ({ isActive = true }) => {
  ...
  const animateMolecule = (
    ...
    const moleculeElements = moleculeData.map((mol) => {
      ...
      element.className =
        "absolute pointer-events-none z-50 flex items-center justify-center rounded-full font-bold text-xs shadow-lg";
