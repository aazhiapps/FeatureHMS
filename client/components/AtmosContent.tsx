...
const contentSections: ContentSection[] = [
  ...
  },
  {
    ...
    description: 'Please sit back, relax, and enjoy the view while we tell you some of our favourite facts about the aviation world.',
    position: 0.3
  },
  {
    id: 'fact1',
    title: 'IN THE DARK',
    description: 'Airplane lights on board are designed so that in the event of an airplane power loss we are able to evacuate the aircraft in 90 minutes.',
    position: 0.5
  },
  {
    id: 'fact2',
    title: 'CREATIVE FLIGHT',
    description: 'Just like our digital projects, every flight follows a carefully planned route with precise timing and creative problem-solving.',
    position: 0.7
  },
  {
    id: 'thankyou',
