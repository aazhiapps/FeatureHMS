...
export const CountdownLoadingScreen = ({ 
  ...
  useEffect(() => {
    ...
    gsap.fromTo(circleRef.current,
      ...
      { opacity: 1, scale: 1, rotation: 0, duration: 1.5, delay: 0.3, ease: "back.out(1.7)" }
    );
        ...
        <div className="relative mb-12">
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <div ref={counterRef} className="text-5xl font-bold text-white mb-2">
                {Math.ceil(countdown)}
              </div>
            ...
            {/* Rotating outer ring */}
            <div className="absolute inset-0 border-2 border-white/20 rounded-full animate-spin" style={{ animationDuration: '10s' }} />
            <div className="absolute inset-2 border border-blue-400/30 rounded-full animate-spin" style={{ animationDuration: '8s', animationDirection: 'reverse' }} />
          </div>
        </div>
        ...
        <div ref={progressRef} className="space-y-6">
          ...
          <div className="bg-black/30 backdrop-blur-md rounded-xl p-4 border border-white/20">
            <div className="flex items-center justify-center space-x-3">
              <div className="relative">
                ...
                <div className="absolute inset-0 w-6 h-6 border-2 border-transparent border-t-green-400 rounded-full animate-spin" style={{ animationDelay: '0.5s', animationDuration: '1.5s' }} />
              </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            {['Database', 'Services', 'Security'].map((system, i) => (
              <div key={system} className="bg-white/5 rounded-lg p-3 border border-white/10">
                <div className="flex items-center space-x-2">
                  <div className={`w-2 h-2 rounded-full ${
                    progress > (i + 1) * 25 ? 'bg-green-400 animate-pulse' : 'bg-gray-500'
                  }`} />
